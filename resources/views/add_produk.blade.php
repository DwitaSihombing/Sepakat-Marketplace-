		...
		<div class="p-3">
			<div class="row">
				<div class="col-12">
					...
					<form method="post" href="/add_produk" enctype="multipart/form-data" >
					@csrf
					<div class="mb-3">
							<label for="nama_produk">Masukkan nama produk</label>
							<textarea class="form-control" name="nama_produk" id="deskripsi" style="height: 10px"></textarea>
							<div class="form-text text-danger">pesan kesalahan</div>
						</div>
						<div class="mb-3">
							<label for="nama_produk">Masukkan harga produk</label>
							<textarea class="form-control" name="harga_produk" id="deskripsi" style="height: 10px"></textarea>
							<div class="form-text text-danger">pesan kesalahan</div>
						</div>
						<div class="row">
							<div class="col-6">
								<div class="mb-3">
									...
									<input type="date" class="form-control" name="tanggal_awal" id="inputTanggalAwal" aria-describedby="tanggalAwalHelp">
							...
							<div class="col-6">
								<div class="mb-3">
									...
									<input type="date" class="form-control" name="tanggal_akhir" id="inputTanggalAkhir" aria-describedby="tanggalAkhirHelp">
						...
						<div class="row">
							<div class="col-6">
								<div class="mb-3">
									...
									<input type="file" name="foto" class="form-control" id="inputFoto" aria-describedby="fotoHelp">
							...
							<div class="col-6">
								<div class="mb-3">
									...
									<select name="tipe_produk" class="form-select">
